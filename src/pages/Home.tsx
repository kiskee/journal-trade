...
import {
  dataAnalisis,
  mostrarResumenMetricas,
  type TradingMetrics,
} from "@/services/dataAnalisis";
  ...
  return (
    <>
      <div className="grid grid-cols-4 grid-rows-4 gap-4 w-screen h-screen px-8 pt-2 pb-19">
        ...
        <div className="col-span-2 shadow-lg shadow-violet-800 flex items-center justify-center h-full bg-neutral-900">
          <Link
            to="/trade"
