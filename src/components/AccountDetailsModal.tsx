...
import { Calendar, DollarSign, Edit2, Save, Star, TrendingUp, Wallet, X } from "lucide-react";
...
export function AccountDetailsModal({ account, isOpen, onClose, onUpdateAccount }: AccountDetailsModalProps) {
